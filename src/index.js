...
var tracklist6 = "Sara Davachi - Buhrstone x Frank Ocean Godspeed blend <br>Ana Caprix x Kamixlo - Como Si Fuera Tu Ultimo<br>Thugwidow - Jesus H Fucking H Christ<br>Max Dahlhaus - MUTATIONS IN TIME<br>Loefah - midnight<br>blastah - D Major XO life<br>Kelela - A Breath Away (Acapella)<br>Dirty K - Ego Fusion (feat Chams)<br>Tension - Cargo<br>Astrosuka - NDS<br>Sophie - Immaterial<br>Funeral - Asfixia<br>Fran G - Destemperado<br>Born in Flamez - Body to mind edit<br>Arca - Urchin<br>SKY H1 & Ssaliva - Dooms x Rosalìa Bagdad Accapella blend<br>Kelela - AQUAPHORIA<br>Lanark Artefax - Touch Absence"
var tracklist7 = "Solange - Beltway <br>King Krule - Out Getting Ribs (Space Cadet Remix) <br>Frank Ocean - Little Demon (Arca Remix) <br> Max Cooper - Repetition <br> Classica - Summer Of Haze <br> TMRW - Deathtrap<br> No Translation - To Resume <br> Duni & FRANCE '98 - Te Ha <br> sale gosse lacoste - j'suis ton boy - ft mia ox <br>Time Warp Device - data drain <br> Brujas (HABIBIBOI VIP_Bami Brujero Remix) <br> M¥SS KETA - IN GABBIA (NON CI VADO) <br> DJ Nigga Fox - LUMI <br> Dj Plead - Kirlis <br> Abssys - Chambiao <br> VFO89 -- GlCtçFnK_2651 <br> Golden - Epifanía (PRE FINAL1) <br> ALonzo - Up All Nigt <br> DYNE - REALLY HOT BAILE <br> Yre Den - Oblong Ark <br> Buraka Som Sistema - Hypnotized <br> Princess Nokia - Tomboy"
var tracklist8 = "KhalilH2OP - Sectioned <br>Concrete fantasies - search and rescue (eternal drift)<br>ssaliva - jazz <br>RIVAL CONSOLES - UNTRAVEL RMX (ONOCLEA SENSIBILIS)<br>LSDXOXO - Black Widow ft. BbyMutha<br>ASJ - Desolation 寂<br>De Grandi - Laguna<br>DJ Plead - Massari and Me<br>Dirty K - Pyroclasm<br>Dj Polo - Date Night at BK<br>Sega Bodega - Nivea<br> EYCEE -Delicate Drippin<br>NOIRE - TWO FUQS<br>Aisha Devi - I'm Not Always Where My Body Is (Varg Remix)<br>ava - well fed<br>Ghoul Boi - Real Fake (unreleased)<br>Clara! y Maoupa - Ruge<br>DECAP × Imaabs - Sofoca Bounca（kojikoji Mushup）"
var tracklist9 ="Sad Girl Club - Ariel Zetina <br> Harvest Charm - Doline <br>Waxwing Air - Huerta <br> Space Apples - Addison Groove <br> UFO (Who R U?) - Renaissance Man <br> Time (feat Parris) - Wen <br> Drinking Coffee Everyday - Bergsonist <br> Forth - Will Lister <br>Diamond Dub - Calibre <br> Pippin - Perko"

var tracklistm1 = "Blood Orange - By Ourselves <br> A$AP Rocky - Purity (Audio) ft. Frank Ocean <br> Yves Tumor - Limerence (Crackberry remix) <br> Yushh - Intense Leg Connection <br> Forever - i-35 <br> CHLO - Ven a mi <br> Kouslin - Sharper <br> Syn - Behemoth <br> SKY H1 - I think I am <br> Inef Coupe - Oil + Water <br> Lorenzo Senni - Dance Tonight Revolution Tomorrow <br> séverine - HEAVENSGATE <br> Hypna - Infrared <br> séverine - CASH CIRCUIT (MEGAN THEE STALLION X M.E.S.H.) <br> Debby Friday - STAY UP <br> Zebra Katz - NO 1 ELSE <br> Arca - Front Load <br> A.G. Cook - Idyll"
var tracklistm2 ="Shushu - So Sick of Lif3 <br> Oblinof - Holotropic (Evil Medvěd Rmx) <br>Xr/Spool - Us Rwht <br> DJ Asbestos - kiss it better (euphoric Glossss mix) <br> GRRL VS 大悲咒 - Impact Mantra (Tzusing Glued) <br> April Bourne & Ezra V - Dike Children <br> Oklou - just level 5 cause its cute <br> Ljj555998 - I'm in love with the slut <br> TSVI - Antares <br> Comastasis - Stagnant <br> Rapala700 - bloto <br> Charli XCX - pink diamond <br> Lou Kessler - Geotraumatics <br> Avbvrn - Residue <br> A.G Cook - XXoplex <br> Stasya - SAVE ROOM FOR 2 <br> Enei - Hot Plate"
...
function BuyStNicolai(){
   window.open("https://kalkatrazcassettes.bandcamp.com/album/st-nicolai");
}

function BuyUBS(){
    window.open("https://guenterraler.bandcamp.com/album/ugly-bathroom-selfies");
}

function BuyKaneda(){
    window.open("https://guenterraler.bandcamp.com/album/kaneda-series");
}
...
function myFunction6() {
  ...
  popup.classList.toggle("show");
  document.querySelector("#myPopup6").innerHTML = `${tracklist6}`
}

function myFunction7() {
  var popup = document.getElementById("myPopup7");
  popup.classList.toggle("show");
  document.querySelector("#myPopup7").innerHTML = `${tracklist7}`
}

function myFunction8() {
  var popup = document.getElementById("myPopup8");
  popup.classList.toggle("show");
  document.querySelector("#myPopup8").innerHTML = `${tracklist8}`
}
function myFunction9() {
  var popup = document.getElementById("myPopup9");
  popup.classList.toggle("show");
  document.querySelector("#myPopup9").innerHTML = `${tracklist9}`
}



function handleMix1() {
  var popup = document.getElementById("m1");
  popup.classList.toggle("show");
  document.querySelector("#m1").innerHTML = `${tracklistm1}`
}

function handleMix2() {
  var popup = document.getElementById("m2");
  popup.classList.toggle("show");
  document.querySelector("#m2").innerHTML = `${tracklistm2}`
}
function handleMix3() {
  var popup = document.getElementById("m3");
  popup.classList.toggle("show");
  document.querySelector("#m3").innerHTML = `${tracklistm3}`
}
function handleMix4() {
  var popup = document.getElementById("m4");
  popup.classList.toggle("show");
  document.querySelector("#m4").innerHTML = `${tracklistm4}`
}
function handleMix5() {
